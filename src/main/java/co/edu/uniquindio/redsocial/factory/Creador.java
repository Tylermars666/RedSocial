...
public class Creador {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //V1
        Image img1 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v1/1.jpg"))));
        Image img2 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v1/2.jpg"))));
        ...
        //V2
        Image img3 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v2/1.jpg"))));
        Image img4 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v2/2.jpg"))));
        ...
        //V3
        Image img5 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v3/1.jpg"))));
        Image img6 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v3/2.jpg"))));
        ...
        //V4
        Image img7 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v4/1.jpg"))));
        Image img8 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v4/2.jpg"))));
        ...
        //V5
        Image img9 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v5/1.jpg"))));
        Image img10 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v5/2.jpg"))));
        ...
        //V6
        Image img11 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v6/1.jpg"))));
        Image img12 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v6/2.jpg"))));
        ...
        //V7
        Image img13 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v7/1.jpg"))));
        Image img14 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v7/2.jpg"))));
        ...
        //V8
        Image img15 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v8/1.jpg"))));
        Image img16 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v8/2.jpg"))));
        ...
        //V9
        Image img17 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v9/1.jpg"))));
        Image img18 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v9/2.jpg"))));
        ...
        //V10
        Image img19 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v10/1.jpg"))));
        Image img20 = new Image(new ByteArrayInputStream(Files.readAllBytes(Paths.get("T:/Windows/DocumentosWin/tmp3/RedSocial/src/main/resources/co/edu/uniquindio/productImg/v10/2.jpg"))));
